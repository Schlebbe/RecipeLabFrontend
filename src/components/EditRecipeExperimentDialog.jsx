...
function EditRecipeExperimentDialog({ experiment, onClose, onUpdated }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const updatedExperiment = await updateRecipeExperiment(experiment.id, {
            ...
            setErrorMessage(error instanceof Error ? error.message : 'Unable to update the experiment.');
        } finally {
...
export default EditRecipeExperimentDialog;
